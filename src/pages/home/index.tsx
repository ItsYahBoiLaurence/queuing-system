...
export default function Home() {
  ...
  const card =
    "bg-white w-full h-full grid place-items-center rounded-lg shadow-sm hover:bg-primary hover:text-white hover:cursor-pointer";
    ...
    <div className={`w-full h-full ${centerGrid}`}>
      <div className=" flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-5 font-bold text-2xl text-center">
          <div className="grid grid-cols-2 gap-5 flex-row min-h-[250px] ">
            <DialogWrapper
